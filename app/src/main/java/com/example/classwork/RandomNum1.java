...
public class RandomNum1 {
    public static void main(String[] args) {
        ...
        for (int[] massive1D: massive2D){
            ...
            for (int massives1D = 0; massives1D < numbers.length; massives1D++){
                for (int elements = 0; elements < numbers[massives1D].length; elements++){
                    System.out.println(numbers[massives1D][elements] + "\t");
                }
                System.out.println();
            }
        }
